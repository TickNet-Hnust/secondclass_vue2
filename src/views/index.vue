            ...
            <el-col :xs="24" :sm="24" :md="12" :lg="8">
                <el-card class="update-log">
                    ...
                    <div class="body">
                        ...
                        <p>
                            <i class="el-icon-user-solid"></i> QQ群：<s
                                >满937441</s
                            >
                            ...
                            <s>满186866453</s>
                            <a
                                href="https://jq.qq.com/?_wv=1027&k=5vYAqA05"
                                target="_blank"
                            >
                                201396349</a
                            >
